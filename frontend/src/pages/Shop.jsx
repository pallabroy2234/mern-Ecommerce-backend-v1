                            ...
                            <div className={`w-3/12 md-lg:w-4/12 md:w-full pr-8  ${filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 'md:h-auto  md:overflow-auto md:mb-0'}]`}>
                                ...
                                <div className="py-3 flex flex-col gap-4">
                                    ...
                                    <div className="flex flex-col gap-3 ">
                                        ...
                                        <div onClick={() => setRatting(parseInt(0))} className={`${ratting === 0 ? "bg-slate-300/50 px-4 " :  "bg-transparent"} pr-4 hover:pl-4 py-2 hover:bg-slate-300/50 transition-all duration-300 cursor-pointer flex flex-row text-orange-500 justify-start items-center gap-2 text-xl`}>
                                                <span><CiStar/></span>
                                                <span><CiStar/></span>
                                                <span><CiStar/></span>
                                                <span><CiStar/></span>
