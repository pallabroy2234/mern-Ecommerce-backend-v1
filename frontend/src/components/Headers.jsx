                    ...
                    <div className="md-lg:w-full w-9/12">
                        <div className="flex justify-between md-lg:justify-center items-center flex-wrap pl-8">
                            <ul className="flex justify-start items-start gap-8 text-sm font-bold uppercase md-lg:hidden">
                                ...
                                <li>
                                    <Link to={"/shop"} className={`p-2 block ${pathname === "/shop" ? "text-dark-moderate-green" : "text-slate-600"}`}>Shop</Link>
                                </li>
                                <li>
                            ...
                            <div className="flex md-lg:hidden justify-center items-center gap-5">
                                ...
                                <div onClick={handleRedirectCartPage} className="relative flex justify-center items-center cursor-pointer w-[35px] h-[35px] rounded-full bg-[#e2e2e2]">
                                    ...
                                    {cartProductCount > 0 ?
                                        <div className="w-[20px] h-[20px] absolute bg-green-500 rounded-full text-white flex text-[12px] justify-center items-center -top-[3px] -right-[5px]">
                                            {cartProductCount}
                                        </div> : null}
                                </div>
                            </div>
