                        ...
                        <tbody>
                        {
                            [1, 2, 3, 4, 5].map((item, index) => (
                                <tr key={index} className="border-b border-slate-700">
                                    <td scope="row" className="px-4 py-2 font-normal whitespace-nowrap">{item}</td>
                                    ...
                                    <td scope="row" className="px-4 py-2 font-normal whitespace-nowrap">
                                        <div className="flex justify-start items-center gap-4">
                                            <Link to={`/admin/dashboard/seller/details/${item}`} className="p-[6px] bg-green-500 rounded-sm hover:shadow-lg hover:shadow-green-500/50"><FaEye/></Link>
