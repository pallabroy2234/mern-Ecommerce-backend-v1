            ...
            <div className="w-[400px] text-[#d0d2d6] p-2">
                <div className="bg-[#283046] p-4 rounded-md">
                    ...
                    <form action="" onSubmit={handleSubmit(submit)}>
                        ...
                        <div>
                            <button type="submit" className="bg-blue-500 w-full hover:shadow-blue-500/50 hover:shadow-lg text-lg px-7 py7 py-2 mb-3 rounded-md">Sign In</button>
                        </div>
                        
                        <div className="flex items-center mb-3 gap-3 justify-center">
                            <p>Don't have an account ? <Link to={"/register"} className="underline">Sign up here</Link>
                            </p>
                        </div>
