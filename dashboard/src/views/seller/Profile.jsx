                                ...
                                userInfo?.shopInfo ?
                                    <div className="flex justify-between text-sm flex-col gap-2 p-4 bg-slate-800 rounded-md relative">
                                        ...
                                        <div className="flex flex-col w-full gap-1 mb-3">
                                            ...
                                            <input type="text" className="px-4 py-2 focus:border-indigo-500 border outline-none  bg-[#283046] border-slate-700 rounded-md text-white my-3" placeholder="Shop Name" id="shopName"/>
                                        </div>
                                        
                                        <div className="flex flex-col w-full gap-1 mb-3">
                                            <label htmlFor="division">Division</label>
                                            <input type="text" className="px-4 py-2 focus:border-indigo-500 border outline-none  bg-[#283046] border-slate-700 rounded-md text-white my-3" placeholder="Division" id="division"/>
                                        </div>
                                        
                                        <div className="flex flex-col w-full gap-1 mb-3">
                                            <label htmlFor="district">District</label>
                                            <input type="text" className="px-4 py-2 focus:border-indigo-500 border outline-none  bg-[#283046] border-slate-700 rounded-md text-white my-3" placeholder="District" id="district"/>
                                        </div>
                                        
                                        <div className="flex flex-col w-full gap-1 mb-3">
                                            <label htmlFor="thana">Thana</label>
                                            <input type="text" className="px-4 py-2 focus:border-indigo-500 border outline-none  bg-[#283046] border-slate-700 rounded-md text-white my-3" placeholder="Thana" id="thana"/>
                                        </div>
